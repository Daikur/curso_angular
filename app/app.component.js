System.register(["angular2/core", "./components/peliculas-list.components", "./components/peliculas-footer.component", "./components/contacto.component", "./components/crear-pelicula.component", "angular2/router"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, peliculas_list_components_1, peliculas_footer_component_1, contacto_component_1, crear_pelicula_component_1, router_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent() {
                    this.titulo = "Peliculas desde Angular 2";
                }
                AppComponent = __decorate([
                    core_1.Component({
                        selector: "mi-app",
                        templateUrl: "app/view/peliculas.html",
                        directives: [peliculas_list_components_1.PeliculasListComponent, peliculas_footer_component_1.PeliculasFooterComponent, contacto_component_1.ContactoComponent, crear_pelicula_component_1.CrearPeliculaComponent, router_1.ROUTER_DIRECTIVES]
                    }),
